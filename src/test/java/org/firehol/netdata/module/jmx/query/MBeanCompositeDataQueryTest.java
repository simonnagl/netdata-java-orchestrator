...
public class MBeanCompositeDataQueryTest {
    ...
    @Test
    public void testQueryInteger() throws AttributeNotFoundException, MBeanException, ReflectionException, InstanceNotFoundException, IOException, JmxMBeanServerQueryException {
    ...
    @Test
    public void testQueryDouble() throws JmxMBeanServerQueryException, AttributeNotFoundException, MBeanException, ReflectionException, InstanceNotFoundException, IOException {
        final CompositeData compositeData = mock(CompositeData.class);
